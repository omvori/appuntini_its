...
nodo * lista_vuota();                        //creazione lista vuota
nodo * lista_in0(nodo * lista,float valore); //inserimento nel primo nodo della lista
nodo *lista_in1(nodo* x, float e);           //inserimento nel secondo nodo della lista
void stampa_lista(nodo* lista);              //stampa della lista
nodo *lista_get(nodo *x, int posizione);     //stampa informazioni in posizione data
nodo *lista_in(nodo *x, int posizione, float e); //inserimento informazione in posizione data 
nodo *lista_out0(nodo *x );                      //elimina il primo nodo della lista
nodo *lista_out1(nodo *x);                       //elimina il secondo nodo della lista
nodo *lista_out(nodo *x, int posizione);         //elimina il nodo in posizione chiesta
int lista_len(nodo *lista );                     //stampa la lunghezza della lista
